...
## Project setup
Note that, <font color=blue>our website is being publicly deployed}</font> (due to server and domain name considerations). Prior to this, you can deploy the project to your local machine using the following commands:
### Install
```
npm install
```
